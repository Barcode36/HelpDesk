...
public class TechnicianDetail extends AppCompatActivity {
            ...
            btnComment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!txtInput.getText().toString().trim().equals("")) {
                        ...
                        Toast.makeText(TechnicianDetail.this, R.string.ticket_comment_toast, Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    public void openSuccessDialog() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                alertDialog.cancel();
                Intent intent = new Intent(TechnicianDetail.this,TechnicianActivity.class);
